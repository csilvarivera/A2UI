...
import * as UI from "@a2ui/lit-field-service/ui";
...
import { config as fieldServiceConfig } from "./configs/field_service.js";
...
export class A2UILayoutEditor extends SignalWatcher(LitElement) {
  ...
  @state()
  accessor config: AppConfig = configs.field_service;
  ...
  connectedCallback() {
    ...
    const appKey = urlParams.get("app") || "field_service";
    this.config = configs[appKey] || configs.field_service;
